...
xcopy ..\..\gips-examples\%MDVNE_PROJECT_NAME%\src-gen ..\%MDVNE_PROJECT_NAME%.migration\src-gen\ /e

rmdir ..\%MDVNE_PROJECT_NAME%.seq\src-gen /s /q
xcopy ..\..\gips-examples\%MDVNE_PROJECT_NAME%\src-gen ..\%MDVNE_PROJECT_NAME%.seq\src-gen\ /e
